      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="mt-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-700 shadow-sm transition-colors hover:bg-gray-50"
          >
